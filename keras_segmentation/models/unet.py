...
def unet_mini(n_classes, input_height=360, input_width=480):
    ...
    conv1 = Conv2D(16, (3, 3), data_format=IMAGE_ORDERING,
    ...
    conv2 = Conv2D(32, (3, 3), data_format=IMAGE_ORDERING,
    ...
    conv3 = Conv2D(64, (3, 3), data_format=IMAGE_ORDERING,
    ...
    conv4 = Conv2D(32, (3, 3), data_format=IMAGE_ORDERING,
    ...
    conv5 = Conv2D(16, (3, 3), data_format=IMAGE_ORDERING,
